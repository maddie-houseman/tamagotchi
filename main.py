...
play_image = pygame.image.load("C:\\Users\\mcost\\OneDrive - Wellington College\\Pictures\\Saved Pictures\\Play Scoreboard.png")
...
play_image = pygame.transform.scale(play_image, (600, 500))  # Resize if needed
